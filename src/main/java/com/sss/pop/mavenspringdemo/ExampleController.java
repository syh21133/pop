package com.sss.pop.mavenspringdemo;
...
public class ExampleController {
    ...
    public ExampleController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSUMPYX9NB5BBYJ", "87ITKLQEZ98OWV9JHTNZL4S2VBALUTDT", "https://api.coolsms.co.kr");
    }
    ...
    // 회원가입 시 전화번호 인증
    @PostMapping("/userPhoneCheck")
    public @ResponseBody String userPhoneCheck(@RequestParam("userPhone") String userPhone) {

        // 실제 시연때는, 여기 주석 싹다 지워주기. 현재는 돈때매 못하는중..

         Message message = new Message();
        String uuid = UUID.randomUUID().toString().substring(0, 6);
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
         message.setFrom("01039179685");
         message.setTo(userPhone);
         message.setText("안녕하세요. 중고거래 사이트 POP(People On People)입니다.\n인증번호는 " + uuid + " 입니다.");
